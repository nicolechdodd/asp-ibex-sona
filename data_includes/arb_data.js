...
var items = [
    ...
    [["src",17], "RLDashedSentence", {s: "الجندي الذي ساعد المدني حصل على ميدالية من الجيش."},
                "Question",       {hasCorrect: 1, q: "هل الجندي حصل على ميدالية؟"}],
    [["orc",17], "RLDashedSentence", {s: "الجندي الذي ساعده المدني حصل على ميدالية من الجيش."},
                "Question",       {hasCorrect: 1, q: "هل الجندي حصل على ميدالية؟"}],
    ...
    [["src",26], "RLDashedSentence", {s: "البستانية التي حسدت صاحبة المنزل تصرفت بشكل لطيف."},
                "Question",       {hasCorrect: 1, q: "هل البستانية حسدت صاحبة المنزل؟"}],
    [["orc",26], "RLDashedSentence", {s: "البستانية التي حسدتها صاحبة المنزل تصرفت بشكل لطيف."},
                "Question",       {hasCorrect: 1, q: "هل صاحبة المنزل حسدت البستانية؟"}],
    ...
    [["src",34], "RLDashedSentence", {s: "الفتاة التي شاهدت الأم غيرت جزءا مهماً من القصة."},
                "Question",       {hasCorrect: 1, q: "هل الفتاة غيرت جزءا مهمًا من القصة؟"}],
    ...
    [["src",39], "RLDashedSentence", {s: "اللص الذي أخاف الشرطي سرق ثلاثة منازل في ليلة واحدة."},
                "Question",       {hasCorrect: 1, q: "هل اللص سرق ثلاثة منازل؟"}],
    [["orc",39], "RLDashedSentence", {s: "اللص الذي أخافه الشرطي سرق ثلاثة منازل في ليلة واحدة."},
                "Question",       {hasCorrect: 1, q: "هل اللص سرق ثلاثة منازل؟"}],

    [["src",40], "RLDashedSentence", {s: "الكاتبة التي أغضبت المحررة كتبت مقالا احتجاجيا."},
                "Question",       {hasCorrect: 0, q: "هل الكاتبة حرقت الكتاب؟"}],
    ...
    ["f-hf", "RLDashedSentence", {s: "أحببت الأسرة الدفّاءة الخاصة بهم ، و لكنهم كرهه الاضطرار تنظيف المدخنة السخانه كل شهر."}],

    ["f-hf", "RLDashedSentence", {s: "بما ان مريم  وصلت متأخره، اعتقدت أن كعكة عيد الميلاد نفذت، ولكن تزال هناك قطعة صغيرة في الصندوق."}],
    ...
    ["f-hf", "RLDashedSentence", {s: "أقام النجم و أصدقاء بحفله ضخمة للاحتفال بعيد ميلاده الخمسين."}],
    ...
    ["f-lf", "RLDashedSentence", {s: "و كانت مطاردة الموطن الرئيسي المشتبه به في السرقات سببت غضباً شعبياً عارما."}],
